      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-4">
          ...
          <div>
            ...
            <input type="text" defaultValue="Karpagam Borewells" className="w-full p-2 border rounded-lg focus:ring-2 focus:ring-[var(--brand-pink)] outline-none" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">GSTIN Number</label>
            <input type="text" defaultValue="33ABCDE1234F1Z5" className="w-full p-2 border rounded-lg focus:ring-2 focus:ring-[var(--brand-pink)] outline-none" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Head Office Address</label>
            <textarea defaultValue="Salem Main Road, Tiruchengode, Namakkal District - 637211" rows={3} className="w-full p-2 border rounded-lg focus:ring-2 focus:ring-[var(--brand-pink)] outline-none"></textarea>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-4">
          <div className="flex items-center gap-3 border-b pb-4">
            <Shield className="text-[#19d219]" size={24} />
          ...
          <div className="space-y-3 mt-4">
            <div className="flex items-center justify-between p-3 border rounded-lg bg-gray-50">
              ...
              <Key size={18} className="text-[#19d219]" />
            </div>
